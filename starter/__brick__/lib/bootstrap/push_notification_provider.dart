...
final pushNotificationServiceProvider = Provider.autoDispose<PushNotificationService>((ref) => PushNotificationService());

final pushNotificationProvider = FutureProvider<void>(isAutoDispose: false, (ref) async {
