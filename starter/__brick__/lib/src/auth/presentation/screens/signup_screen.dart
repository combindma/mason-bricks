        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('signup.title'.tr(), style: context.headlineSmall, textAlign: TextAlign.center),
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () => context.pushNamed(Routes.signupForm.name),
                          child: Text('login.continue_email'.tr()),
                        ),
                      ),
                      const SizedBox(height: 24),
                      Text(style: context.labelMedium, 'login.have_account'.tr()),
                      TextButton(
                        onPressed: () => context.pushNamed(Routes.login.name),
                        child: Text('log in'.tr(), style: context.bodyMedium).bold,
                      ),
                    ],
                  );
                },
